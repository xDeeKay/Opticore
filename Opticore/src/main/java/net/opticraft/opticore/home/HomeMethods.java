...
public class HomeMethods {
	...
	public HomeMethods(Main plugin) {
		this.plugin = plugin;
		...
		if (homeConfig.isSet("homes." + uuid)) {
			...
			if (!homes.isEmpty()) {
				...
				for (String home : homes) {
					...
					plugin.players.get(player.getName()).getHomes().put(home, new HomeInfo(item, locked, world, x, y, z, yaw, pitch));
				}
			}
		}
	}
	...
	public void setHome(Player player, String home, Location location, String item, boolean locked) {
